    ...
    <div class="container">
        ...
        <div class="phone-div">   
            ...
            <div class="form-group submit" >
                <a style="color:#fff" class="ps-btn ps-btn--fullwidth sendOTP" ><span>{{ __(' Send OTP') }}</span></a>
            </div>
            <span class="d-block text-center my-4 text-muted">— or —</span>
            <div class="form-group submit">
                <a class="ps-btn ps-btn--fullwidth" style="color:#fff" href="{{ route('customer.register') }}" >{{ __('Sign up By Email') }}</a>
            </div>
        </div>     
        <div class="otp-div" style="display:none">
            ...
            <div class="form-group submit" >
                <a id="verifyOTP" style="color:#fff" class="ps-btn ps-btn--fullwidth" >{{ __('Verify OPT') }}</a>
            </div>
        </div>
